...
namespace Utils{
	...
	*/    
//dialogType：指定对话框类型，0表示打开文件对话框，非零值表示保存文件对话框
//initialDir：指定打开对话框时显示的初始目录，如果为空，则使用默认目录
//filter：指定可供用户选择的文件类型过滤器，例如："CSV Files (.csv)\0.csv\0All Files (.)\0*.*\0"
/*它会返回你打开窗口之后的那个文件  E:\Project\GPBD\test.txt*/
